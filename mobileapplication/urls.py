...
urlpatterns = [
    ...
    path("mobile/add",views.MobileCreateView.as_view(),name="mobile-create"),
    path("mobile/<int:pk>/change",views.MobileUpdateView.as_view(),name="mobile-change"),
    path("mobile/register",views.SignUpView.as_view(),name="register"),
    path("",views.SignInView.as_view(),name="signin"),
    path("mobile/logout",views.SignOutView.as_view(),name="signout"),
